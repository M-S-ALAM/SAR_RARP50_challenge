...
class ModelTrainer:
    ...
    def __init__(self, train_csv_file, test_csv_file, num_epochs=1000, batch_size=8):
        self.train_csv_file = train_csv_file
        self.test_csv_file = test_csv_file
        self.num_epochs = num_epochs
        self.batch_size = batch_size
        self.device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
        self.model = UNetPlusPlus(n_channels=3, n_classes=10).to(self.device)
...
if __name__ == "__main__":
    trainer = ModelTrainer('/home/shobot/Shahbaz_project/SAR_RARP50_challenge/Database/train_data.csv',
                           '/home/shobot/Shahbaz_project/SAR_RARP50_challenge/Database/test_data.csv')
    trainer.train()
